 ...
 */
$GLOBALS['FE_MOD']['cts']['cookiehandlebar'] = '\Esit\CookieHandleBar\Classes\Contao\Modules\ModuleCookieHandleBar';
 ...
 * CTS - COOKIEBAR
 */
$GLOBALS['CTS']['COOKIEBAR']['COOKIELIFETIME']      = 7;                // Lebensdauer des Cookies für die Cookie-Einstellungen in Tagen.
$GLOBALS['CTS']['COOKIEBAR']['CTRLCOOKIEPREFIX']    = 'ctrlCookie-';    // Präfix des Kontrollcookies der Cookiebar.
$GLOBALS['CTS']['COOKIEBAR']['COOKIESETTINGPREFIX'] = 'chb-';           // Präfix der einzelnen Cookieeinstellungen.